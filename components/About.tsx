    ...
    return (
        ...
        >
            ...
            <motion.img
                ...
                src="/images/daphine_andrew.jpg" alt="This is me an dmy wife"
                className={"-mb-20 md:mb-0 flex-shrink-0 w-56 h-56 sm:w-60 sm:w-full md:w-64 md:h-95  xl:w-[500px] xl:h-[600px]  object-cover rounded-full md:rounded-lg"}
            />
